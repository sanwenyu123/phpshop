<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./template/pc/default/cart\ajax_cart_list.html";i:1490353006;}*/ ?>
        ...
        <td align="center" valign="middle">
            <div class="sc-stock-area">
                <div class="stock-area">                            
                    ...
                    <input class="wi43 fl" type="text" value="<?php if($v[goods_num] > $v[store_count]): ?><?php echo $v[store_count]; else: ?><?php echo $v[goods_num]; endif; ?>" name="goods_num[<?php echo $v['id']; ?>]" id="goods_num[<?php echo $v['id']; ?>]" readonly="" />
