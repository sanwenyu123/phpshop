    ...
    <div class="layout pa-to-10">
        ...
        <div class="left-area">
            <div class="left-area-tb">
                <div class="pro-gallery-img">
                    <div class="jqzoom"> <img id="zoomimg" src="<?php echo goods_thum_images($goods['goods_id'],400,400); ?>" jqimg="<?php echo goods_thum_images($goods['goods_id'],800,800); ?>" width="480px" height="480px" alt=""/> </div>
                </div>
                <!-- 修改的部分-start -->
                        ...
                        <div class="pro-gallery-thumbs">
                            <ul class="small-pic" id="pro-gallerys" style="left: 0px;">
                                <?php if(is_array($goods_images_list) || $goods_images_list instanceof \think\Collection): if( count($goods_images_list)==0 ) : echo "" ;else: foreach($goods_images_list as $k=>$v): ?>
                                    <li class="small-pic-li <?php if($k == 0): ?>current<?php endif; ?>">
                                    <!--<a href="javascript:void(0);">-->
                                        <!--<img src="<?php echo goods_thum_images($v['goods_id'],60,60); ?>" data-img="<?php echo goods_thum_images($v['goods_id'],400,400); ?>" data-big="<?php echo goods_thum_images($v['goods_id'],800,800); ?>">-->
                                    <!--</a>-->
        ...
        <div class="right-area-num">
            <div class="right-area">
                <div class="right-area-le30">
                    ...
                    <div class="cpxq-explain">
                        <?php if($flash_sale['description'] != ''): ?>
                            <?php echo $flash_sale['description']; else: ?>
                ...
                <?php if($goods['prom_type'] == 1): ?>
                    <div class="bef_fo2" style="font-size:14px; background-color:#F60; color:#FFFFFF; line-height:30px; position:absolute; width:100%">
                        <p style="background-color:#f72862">
                            ...
                            <img class="clock_w" src="__STATIC__/images/lz.png"/><span id="surplus_text">300天 01时 01分 01秒</span> 后结束，请快购买
                        </p>
                    </div>
                    <script>
                        // 倒计时
                ...
                <div class="right-area-le30 pa-3-0-0-30">
                    ...
                    <div class="pro-promotions-area">
                        <table class="promotions-tab" width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <?php if(($goods['shop_price'] >= ($goods['exchange_integral']/$point_rate)) AND $goods['exchange_integral'] > 0): ?>
                                <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="jiathis_style">
                                        <a href="http://www.jiathis.com/share" class="jiathis jiathis_txt" target="_blank"><img src="/public/plugins/jiathis/jiathis1.gif" border="0" /></a>
                                    </div>
                                    <script>
                                        var jiathis_config = {
                                            url:"http://<?php echo $_SERVER[HTTP_HOST]; ?>/index.php?m=Home&c=Goods&a=goodsInfo&id=<?php echo \think\Request::instance()->param('id'); ?>",
            ...
            <form name="buy_goods_form" method="post" id="buy_goods_form" >
                <div class="right-area he315 ma-to--1" style="height: 246px;">
                    <div class="right-area-le30 pa-3-0-0-30" style="padding:0 0 0 30px">
                        <div class="pro-promotions-area">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="choice-colol ma-le-6">
                                                <?php if(is_array($v) || $v instanceof \think\Collection): if( count($v)==0 ) : echo "" ;else: foreach($v as $k2=>$v2): if($v2[src] != ''): ?>
                                                        <li>
                                                            <div class="color-sku-fant">
                                                                <div class="sku <?php if($k2 == 0): ?>sku-bo-blo<?php endif; ?>">
                                                    <a onClick="switch_spec(this)"><img src="<?php echo $v2[src]; ?>"  onClick="$('#zoomimg').attr('src','<?php echo $v2[src]; ?>');$('#zoomimg').attr('jqimg','<?php echo $v2[src]; ?>');"/></a>
            ...
            <div class="history-bott">
                <ul class="history-comm">
                    <?php
                                ...
                                $md5_key = md5("select * from `__PREFIX__goods` where is_recommend = 1 order by goods_id desc limit 10");
                                $result_name = $sql_result_v = S("sql_".$md5_key);
                                if(empty($sql_result_v))
                                {                            
                                    $result_name = $sql_result_v = \think\Db::query("select * from `__PREFIX__goods` where is_recommend = 1 order by goods_id desc limit 10"); 
                                    S("sql_".$md5_key,$sql_result_v,31104000);
                                }    
                              foreach($sql_result_v as $k=>$v): ?>
                        <li>
            ...
            <div class="parame-bott cliks-bn" style="display:none"  id="tab4">
                <div class="commodity-num pro-feature-area wi850 padding36-0-36-0">
                    <?php
                                ...
                                $md5_key = md5("select * from `__PREFIX__article` where article_id = 1");
                                $result_name = $sql_result_v = S("sql_".$md5_key);
                                if(empty($sql_result_v))
                                {                            
                                    $result_name = $sql_result_v = \think\Db::query("select * from `__PREFIX__article` where article_id = 1"); 
                                    S("sql_".$md5_key,$sql_result_v,31104000);
                                }    
                              foreach($sql_result_v as $k=>$v): ?>
                        <?php echo htmlspecialchars_decode($v[content]); endforeach; ?>
                </div>
            </div>
            <!-------------------用户评价------------------>
                ...
                <div class="evaluation-top fo-fa di-in-bl">
                    ...
                    <div class="eval-le2 fl wi123 pa-to-7">
                        <dl>
                            ...
                            <dd><s style=" width:<?php echo $commentStatistics['rate1']; ?>%"></s></dd>
                        </dl>
                        <dl>
                            <dt>中评<em>(<?php echo $commentStatistics['rate2']; ?>%)</em></dt>
                            <dd><s style=" width:<?php echo $commentStatistics['rate2']; ?>%"></s></dd>
                        </dl>
                        <dl>
                            <dt>差评<em>(<?php echo $commentStatistics['rate3']; ?>%)</em></dt>
                            <dd><s style=" width:<?php echo $commentStatistics['rate3']; ?>%"></s></dd>
                        </dl>
                    </div>
...
<script>
    ...
    function get_goods_price()
    {
        ...
        // 如果有属性选择项
        if(Array.isArray(spec_goods_price) != true)
        {
